"""
```
augment_states(m::CurdiaReis, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Matrix{T}) where {T<:AbstractFloat}
```
...
"""
function augment_states(m::CurdiaReis, TTT::Matrix{T}, RRR::Matrix{T},
